...
Im vorigen Abschnitt \ref{cha:KeywordGrammar} wurde die Grammatik eines \enword{Keywords} der Sprache Rayden erklärt. Dieser Abschnitt beschäftigt sich mit der Ausführung von \enword{Keywords}. Damit der Interpretierer arbeiten kann, benötigt diese den Zugriff auf den abstrakten Syntaxbaum. 
...
\SuperPar
Wurden alle Gültigkeitsbereich am \enword{Stack} erfolgreich abgearbeitet, werden am Ende noch alle \enword{Reporter-Objekte} aufgerufen. Danach wird die Ausführung des Interpretierers beendet.
