...
Da Rayden eine eigene \enword{Runtime} besitzt, können keine bestehenden \enword{Debugger} verwendet werden, um einen Rayden-Test zu analysieren. Darum wäre die Implementierung eines eigenen \enword{Debuggers} für die Sprache vorteilhaft. Zusätzlich könnte man mit dieser Erweiterung einen Test Schritt für Schritt ausführen. Somit könnten Fehler schneller aufgespürt und behoben werden.\\
